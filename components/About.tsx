...
const handleImageError = (e: React.SyntheticEvent<HTMLImageElement, Event>) => {
  // This is a high-end, branded SVG fallback that WILL NOT BREAK.
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left">
            <h2 className="text-indigo-600 font-black uppercase tracking-[0.4em] text-[10px] mb-4">Our Identity</h2>
            <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 md:mb-8 leading-[0.9] tracking-tighter">Engineering <br className="hidden md:block"/>on Precision.</h3>
            <p className="text-slate-500 mb-8 text-base md:text-lg font-medium leading-relaxed max-w-xl mx-auto lg:mx-0">
              Smart Solutions is a premier engineering studio in New Cairo. We specialize in high-performance digital infrastructure for the global education sector.
            </p>
            
            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto lg:mx-0">
              <div className="p-8 rounded-[2.5rem] bg-indigo-50 border border-indigo-100 text-left">
                <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-indigo-600 shadow-sm mb-4">✓</div>
                <h4 className="font-bold text-indigo-900 uppercase text-[9px] tracking-widest mb-1">Scale</h4>
                <p className="text-[11px] text-indigo-600/70 font-bold leading-tight">Millions of interactions handled daily.</p>
              </div>
              <div className="p-8 rounded-[2.5rem] bg-slate-900 border border-slate-800 text-left">
                <div className="w-10 h-10 bg-slate-800 rounded-xl flex items-center justify-center text-indigo-400 shadow-sm mb-4">✓</div>
                <h4 className="font-bold text-white uppercase text-[9px] tracking-widest mb-1">Trust</h4>
                <p className="text-[11px] text-slate-400 font-bold leading-tight">Bank-grade data privacy standards.</p>
              </div>
            </div>
          </div>
        </div>
