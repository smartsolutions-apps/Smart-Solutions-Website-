...
const LegalModal: React.FC<LegalModalProps> = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 sm:p-12">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-4xl max-h-[85vh] bg-white rounded-[3rem] shadow-2xl flex flex-col overflow-hidden animate-scaleIn border border-white/20">
        {/* Header */}
        ...
        <div className="p-6 border-t border-slate-100 bg-slate-50 flex justify-end shrink-0">
          <button 
            onClick={onClose}
            className="px-8 py-3 bg-slate-900 text-white font-black text-xs uppercase tracking-widest rounded-xl hover:bg-indigo-600 transition-all"
          >
            Acknowledge & Close
          </button>
        </div>
